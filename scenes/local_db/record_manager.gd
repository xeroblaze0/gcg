...
func make_record(game_seed: int, move_count: int, undo_count: int, game_time: int, score: int, game_state: MatchState.GameResult) -> void:
	var record_id = ""
	while true:
...
func save_running_game_info(game_seed: int, move_count: int, undo_count: int, game_time: int, score: int, game_state: MatchState.GameResult) -> void:
	if game_state != MatchState.GameResult.IN_PROGRESS:
		return
